...
PRODUCT_NAME := m200_th03
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := m200_th03
PRODUCT_MODEL := m200_th03
...
PRODUCT_COPY_FILES += \
	device/amlogic/common/init/mbx/init.amlogic.panel.rc:root/init.amlogic.rc \
...
$(call inherit-product-if-exists, vendor/amlogic/m200/device-vendor.mk)
