...
#for DTV compile
$(shell mkdir -p out/target/product/n200C_th12/obj/SHARED_LIBRARIES/libth_dtv_pi_intermediates)
$(shell touch out/target/product/n200C_th12/obj/SHARED_LIBRARIES/libth_dtv_pi_intermediates/export_includes)
$(shell mkdir -p out/target/product/n200C_th12/obj/SHARED_LIBRARIES/libth_dtv_other_intermediates)
$(shell touch out/target/product/n200C_th12/obj/SHARED_LIBRARIES/libth_dtv_other_intermediates/export_includes)
$(shell mkdir -p out/target/product/n200C_th12/obj/SHARED_LIBRARIES/libth_dtv_mw_intermediates)
$(shell touch out/target/product/n200C_th12/obj/SHARED_LIBRARIES/libth_dtv_mw_intermediates/export_includes)
$(shell mkdir -p out/target/product/n200C_th12/obj/lib)
$(shell touch out/target/product/n200C_th12/obj/lib/libth_dtv_pi.so)
$(shell touch out/target/product/n200C_th12/obj/lib/libth_dtv_other.so)
$(shell touch out/target/product/n200C_th12/obj/lib/libth_dtv_mw.so)
$(shell mkdir -p out/target/product/n200C_th12/system/lib)
...
PRODUCT_NAME := n200C_th12
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := n200C_th12
PRODUCT_MODEL := n200C_th12
...
$(call inherit-product-if-exists, vendor/amlogic/n200C_th12/device-vendor.mk)
