...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m201_chz
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m201_chz/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m201_chz/aml_logo.bmp
# Check Logo Size
