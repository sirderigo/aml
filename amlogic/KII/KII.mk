...
# KII:
# To build for KII
#force build wifi lib & wpa
$(shell rm -rf out/target/product/KII/obj/STATIC_LIBRARIES/lib_driver_cmd_bcmdhd_intermediates)
$(shell rm -rf out/target/product/KII/obj/STATIC_LIBRARIES/lib_driver_cmd_nl80211_intermediates)
$(shell rm -rf out/target/product/KII/obj/SHARED_LIBRARIES/libwpa_client_intermediates)
$(shell rm -rf out/target/product/KII/obj/SHARED_LIBRARIES/libhardware_legacy_intermediates)
$(shell rm -rf out/target/product/KII/obj/EXECUTABLES/hostapd_cli_intermediates)
$(shell rm -rf out/target/product/KII/obj/EXECUTABLES/hostapd_intermediates)
$(shell rm -rf out/target/product/KII/obj/EXECUTABLES/wpa_supplicant_intermediates)
$(shell rm -rf out/target/product/KII/obj/KERNEL_OBJ/include/generated/compile.h)
...
ifeq ($(KII_WIFI_MODEL), AP6330)
WIFI_MODULE := bcm40183
WIFI_AP6xxx_MODULE := AP6330

PRODUCT_PROPERTY_OVERRIDES += \
ro.platform.wifi.module=ap6330
else
WIFI_MODULE := rtl8192du

PRODUCT_PROPERTY_OVERRIDES += \
ro.platform.wifi.module=8192du
endif
...
ifeq ($(KII_WIFI_MODEL), AP6330)
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/init.amlogic.board.ap6330.rc:root/init.amlogic.board.rc
else
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/init.amlogic.board.rtl8192.rc:root/init.amlogic.board.rc
endif
...
$(call inherit-product-if-exists, vendor/amlogic/KII/device-vendor.mk)
