...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := n301
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/n301/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/n301/aml_logo.bmp
# Check Logo Size
...
# use 32M = 33554432 as hash table
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1040187392
else
...
include device/amlogic/$(TARGET_PRODUCT)/sepolicy/sepolicy.mk
