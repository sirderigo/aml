...
BOARD_MKBOOTIMG_ARGS := --second $(KERNEL_OUT)/arch/arm/boot/dts/amlogic/meson8b_m102_th03_1G.dtb
...
cp $(KERNET_ROOTDIR)/arch/arm/boot/dts/amlogic/meson8b_m102_th03_1G.dtd $(PRODUCT_OUT)/meson_target.dtd
...
cp $(KERNEL_OUT)/arch/arm/boot/dts/amlogic/meson8b_m102_th03_1G.dtb $(PRODUCT_OUT)/meson.dtb
...
$(TARGET_PREBUILT_KERNEL): $(KERNEL_OUT) $(KERNEL_CONFIG)
	...
	$(MAKE) -C $(KERNET_ROOTDIR) O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(KERNEL_COMPILE) meson8b_m102_th03_1G.dtd
	$(MAKE) -C $(KERNET_ROOTDIR) O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(KERNEL_COMPILE) meson8b_m102_th03_1G.dtb
