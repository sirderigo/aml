...
case $1 in 
    ...
    panel)
        fbset -fb /dev/graphics/fb0 -g 1280 800 1280 2400 32
        echo 1 > /sys/class/graphics/fb1/blank
        fbset -fb /dev/graphics/fb1 -g 1280 720 1280 2160 32
        echo $1 > /sys/class/display/mode
        echo 0 0 1280 800 0 0 1280 720 > /sys/class/display/axis
    ;;
