...
KERNEL_DEVICETREE := mesong9tv_n300

ifeq ($(N300_DDR_SIZE) , n300_15G_ddr)
    KERNEL_DEVICETREE := mesong9tv_n300_15g
else
    ifeq ($(N300_DDR_SIZE) , n300_1G_ddr)
        KERNEL_DEVICETREE := mesong9tv_n300_1g
    else
        KERNEL_DEVICETREE := mesong9tv_n300
    endif
endif  
