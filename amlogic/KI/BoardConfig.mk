...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := KI
...
#TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/KI/res_pack_bax101
ifeq ($(CUSTOM_MODEL),cs)
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/KI/res_pack_cs
else ifeq ($(CUSTOM_PRODUCT_MODEL), MXQ)
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/KI/res_mxq
else ifeq ($(CUSTOM_MODEL), CLauncher)
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/KI/res_pack_CLauncher
else
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/KI/res_pack
endif
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/KI/aml_logo.bmp
# Check Logo Size
