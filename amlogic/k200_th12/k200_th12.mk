...
#for DTV compile
$(shell mkdir -p out/target/product/k200_th12/obj/SHARED_LIBRARIES/libth_dtv_pi_intermediates)
$(shell touch out/target/product/k200_th12/obj/SHARED_LIBRARIES/libth_dtv_pi_intermediates/export_includes)
$(shell mkdir -p out/target/product/k200_th12/obj/SHARED_LIBRARIES/libth_dtv_other_intermediates)
$(shell touch out/target/product/k200_th12/obj/SHARED_LIBRARIES/libth_dtv_other_intermediates/export_includes)
$(shell mkdir -p out/target/product/k200_th12/obj/SHARED_LIBRARIES/libth_dtv_mw_intermediates)
$(shell touch out/target/product/k200_th12/obj/SHARED_LIBRARIES/libth_dtv_mw_intermediates/export_includes)
$(shell mkdir -p out/target/product/k200_th12/obj/lib)
$(shell touch out/target/product/k200_th12/obj/lib/libth_dtv_pi.so)
$(shell touch out/target/product/k200_th12/obj/lib/libth_dtv_other.so)
$(shell touch out/target/product/k200_th12/obj/lib/libth_dtv_mw.so)
$(shell mkdir -p out/target/product/k200_th12/system/lib)
...
PRODUCT_NAME := k200_th12
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := k200_th12
PRODUCT_MODEL := K200_th12
...
ifneq ($(filter M8B M8,$(PLATFORM_NAME)),)
...
ifneq ($(filter AML_DVB_TV,$(DVB_TYPE)),)
##  MediaBoxLauncher
PRODUCT_PACKAGES += \
	MediaBoxLauncher
