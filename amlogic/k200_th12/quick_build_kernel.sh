...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
PROJECT_NAME=k200_th12
if [ "${DVB_TYPE}" == "AML_DVB_TV" ]; then
	PROJECT_DT=meson8_k200a_th12_amldtv_2G
	KERNEL_DEFCONFIG=meson8_th12_amldtv_defconfig
else
	PROJECT_DT=meson8_k200a_th12_2G
	KERNEL_DEFCONFIG=meson8_th12_defconfig
fi
...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
cp ${KERNEL_OUT}/../hardware/amlogic/nand/amlnf/aml_nftl_dev.ko ${PRODUCT_OUT}/root/boot/
${KERNEL_OUT}/../hardware/amlogic/pmu/aml_pmu_dev.ko ${PRODUCT_OUT}/system/lib/
#}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
