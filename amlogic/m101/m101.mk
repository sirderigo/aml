...
#touch firmware	
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/touch/gsl1680e_m101.cfg:system/etc/touch/gsl1680e_m101.cfg \
	$(LOCAL_PATH)/touch/gsl1680e_m101.fw:system/etc/touch/gsl1680e_m101.fw
...
$(call inherit-product-if-exists, vendor/amlogic/m101/device-vendor.mk)
