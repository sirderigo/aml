...
busybox echo 0 > /sys/class/graphics/fb0/free_scale
	...
	case $outputmode in 
		...
		busybox echo 0 0 719 479 > /sys/class/graphics/fb0/window_axis 
		;;
    
		576*)
		busybox echo 0 0 1919 1079 > /sys/class/graphics/fb0/free_scale_axis
		busybox echo 0 0 719 576 > /sys/class/graphics/fb0/window_axis 
		;; 

		720*)
		busybox echo 0 0 1919 1079 > /sys/class/graphics/fb0/free_scale_axis
		busybox echo 0 0 1279 719 > /sys/class/graphics/fb0/window_axis 
		;; 

		1080*)
		busybox echo 0 0 1919 1079 > /sys/class/graphics/fb0/free_scale_axis
		busybox echo 0 0 1919 1079 > /sys/class/graphics/fb0/window_axis 
		;; 
