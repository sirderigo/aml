...
$(call inherit-product, device/amlogic/m201_th0/version_id.mk)
...
PRODUCT_NAME := m201_th0
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := m201_th0
PRODUCT_MODEL := m201
...
PRODUCT_PROPERTY_OVERRIDES += \
    ro.fix.home=true \
    ro.home.activity=cn.cibntv.launcher.MainActivity
    
PRODUCT_PACKAGES += \
	AppManager \
	CIBNLauncher-1226-2-sign \
	STBDaemon-1122-s805-60s-F_sign \
	tools-signed \
	tvm_cibn_taiguo_yh_
endif
...
PRODUCT_PACKAGES += \
	AppManager \
	EPG-JXDX805-VER3.52.108-20141230-F_sign \
	STBDaemon-1122-s805-60s-F_sign \
	tools-signed
...
PRODUCT_PACKAGES += \
	AppManager \
	EPG-S805-VER3.52.108-20141230-F_sign \
	STBDaemon-1122-s805-60s-F_sign \
	tools-signed
...
PRODUCT_PACKAGES += \
	AppManager \
	EPG-S805DSBB-VER3.52.108-20150107-F \
	STBDaemon-1122-s805-60s-F_sign \
	tools-signed
...
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/timehold/QuanZhouDianXin/libhello-jni.so:system/lib/libhello-jni.so
	
PRODUCT_PACKAGES += \
	StartServices \
	bmc_2.2.1 \
	ChinatelecomTMCServiceV1-sign \
	EPG-QZDX-VER3.521.107-20141218 \
	Ott_shq_v2.0_wai_11_14 \
	TMC_2.1.7 \
	AppManager \
	tools-signed
endif
...
PRODUCT_COPY_FILES += \
  ...
  $(LOCAL_PATH)/boot.mov:system/etc/bootvideo 

# timehold
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/timehold/libupdatelogo.so:system/lib/libupdatelogo.so \
	$(LOCAL_PATH)/timehold/imgpack:system/bin/imgpack
	
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/timehold/lib/libaccstub.so:system/lib/libaccstub.so \
	$(LOCAL_PATH)/timehold/lib/libalgmsyoukutv.so:system/lib/libalgmsyoukutv.so \
	$(LOCAL_PATH)/timehold/lib/libamplayer_hw.so:system/lib/libamplayer_hw.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_allwinner_hw_41.so:system/lib/libdecengine_allwinner_hw_41.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_hw_23.so:system/lib/libdecengine_hw_23.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_hw_40.so:system/lib/libdecengine_hw_40.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_hw_41.so:system/lib/libdecengine_hw_41.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_hw_43.so:system/lib/libdecengine_hw_43.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_RK_mc_44.so:system/lib/libdecengine_RK_mc_44.so \
	$(LOCAL_PATH)/timehold/lib/libdecengine_RK_sf_44.so:system/lib/libdecengine_RK_sf_44.so \
	$(LOCAL_PATH)/timehold/lib/libluajavayoukutv.so:system/lib/libluajavayoukutv.so \
	$(LOCAL_PATH)/timehold/lib/libmath_codecs.so:system/lib/libmath_codecs.so \
	$(LOCAL_PATH)/timehold/lib/libmediacodec_hw.so:system/lib/libmediacodec_hw.so \
	$(LOCAL_PATH)/timehold/lib/libMMANDKSignature.so:system/lib/libMMANDKSignature.so \
	$(LOCAL_PATH)/timehold/lib/libsmartlangdet.so:system/lib/libsmartlangdet.so \
	$(LOCAL_PATH)/timehold/lib/libstream_ghost.so:system/lib/libstream_ghost.so \
	$(LOCAL_PATH)/timehold/lib/libbspatch.so:system/lib/libbspatch.so \
	$(LOCAL_PATH)/timehold/lib/libcocos2dcpp.so:system/lib/libcocos2dcpp.so \
	$(LOCAL_PATH)/timehold/lib/libsystem_detect.so:system/lib/libsystem_detect.so
