...
$(call inherit-product, device/amlogic/m201_512m_th01/version_id.mk)
...
PRODUCT_NAME := m201_512m_th01
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := m201_512m_th01
PRODUCT_MODEL := m201_512m_th01
...
ifeq ($(BUILD_APK),B2B)
PRODUCT_PROPERTY_OVERRIDES += \
    ro.redkey.package=com.live.webepglive \
    ro.redkey.class=com.live.webepglive.Startup \
    ro.greenkey.package=com.voole.playback \
    ro.greenkey.class=com.voole.playback.view.MainActivity \
    ro.yellowkey.package=com.voole.webepg \
    ro.yellowkey.class=com.voole.webepg.NewStartup
    
PRODUCT_PACKAGES += \
	PLAYBACK_711_gdunion \
	VooleDeskTop_300093_20141217 \
	VooleWebEpg_300093_20141021 \
	WebEpgLive_711_20141103
endif

ifeq ($(BUILD_APK),B2C)
PRODUCT_PROPERTY_OVERRIDES += \
    ro.redkey.package=com.voole.magictv \
    ro.redkey.class=com.voole.magictv.view.PlayerActivity \
    ro.greenkey.package=com.voole.playback \
    ro.greenkey.class=com.voole.playback.view.MainActivity \
    ro.yellowkey.package=com.voole.epg \
    ro.yellowkey.class=com.voole.epg.view.movies.RecommendActivity
    
PRODUCT_PACKAGES += \
	MAGICTV_1.3.00000015_100045_20141117.095415_20141117 \
	PLAYBACK_1.3.00000015_100045_20141027.162249_20141031 \
	VooleDeskTop_100058_20141218 \
	VOOLEPLAYAPK_2.31.00002115_100045_20141030.154838_20141111 \
	TvStore_1.1.0.0011_100137_20140725_release
endif
...
# timehold
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/timehold/libgeneralglib.so:system/lib/libgeneralglib.so \
	$(LOCAL_PATH)/timehold/libvooleglib.so:system/lib/libvooleglib.so
