...
BOARD_MKBOOTIMG_ARGS := --second $(KERNEL_OUT)/arch/arm/boot/dts/amlogic/meson8_k150_v1.dtb
...
cp $(KERNET_ROOTDIR)/arch/arm/boot/dts/amlogic/meson8_k150_v1.dtd $(PRODUCT_OUT)/meson_target.dtd
...
cp $(KERNEL_OUT)/arch/arm/boot/dts/amlogic/meson8_k150_v1.dtb $(PRODUCT_OUT)/meson.dtb
$(THERMAL_KO):
...
$(TARGET_PREBUILT_KERNEL): $(KERNEL_OUT) $(KERNEL_CONFIG)
	...
	$(MAKE) -C $(KERNET_ROOTDIR) O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(KERNEL_COMPILE) meson8_k150_v1.dtd
	$(MAKE) -C $(KERNET_ROOTDIR) O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(KERNEL_COMPILE) meson8_k150_v1.dtb
