...
PRODUCT_NAME := m201_512m_th8
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := m201_512m_th8
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/HiveviewSetting.apk:system/app/HiveviewSetting.apk \
	$(LOCAL_PATH)/QiyiVideo-release-drpeng.domyvod-blv10476-tv3.6-r22954.apk:system/app/QiyiVideo-release-drpeng.domyvod-blv10476-tv3.6-r22954.apk \
...
$(call inherit-product-if-exists, vendor/amlogic/m201_512m_th8/device-vendor.mk)
