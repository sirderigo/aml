...
include frameworks/native/build/mbox-512-dalvik-heap.mk
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/disable_cpu_freq_limit.sh:system/bin/disable_cpu_freq_limit.sh \
...
ifneq ($(filter g35_1G,$(BOARD_REVISION)),)
PRODUCT_COPY_FILES += \
...
$(call inherit-product-if-exists, vendor/amlogic/g35/device-vendor.mk)
