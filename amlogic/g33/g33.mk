...
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/g33_1G/init.amlogic.board.rc:root/init.amlogic.board.rc 
else
PRODUCT_COPY_FILES += \
...
$(call inherit-product-if-exists, vendor/amlogic/g33/device-vendor.mk)
