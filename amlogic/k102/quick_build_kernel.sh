...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
PROJECT_NAME=k102
PROJECT_DTB=meson8_k102_v1.dtb
KERNEL_DEFCONFIG=meson8_defconfig
KERNET_ROOTDIR=common
PREFIX_CROSS_COMPILE=arm-linux-gnueabihf-
if [ ! -n $PREFIX_CROSS_COMPILE ]; then
   echo "NOT NULL"
else
   PREFIX_CROSS_COMPILE=$DEFAULT_KERNEL_TOOLCHAIN
   echo "IS NULL"
fi 
#}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
...
make -C $KERNET_ROOTDIR O=../$KERNEL_OUT ARCH=arm CROSS_COMPILE=$PREFIX_CROSS_COMPILE meson8_k102_v1.dtd
