...
if [ "${K101_DDR_SIZE}" == "k101_1G_ddr" ]; then
    KERNEL_DEVICETREE=meson8_k101_1G
elif [ "${K101_DDR_SIZE}" == "k101_512M_ddr" ]; then
    KERNEL_DEVICETREE=meson8_k101_512M
fi
...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
cp $OUT/obj/hardware/wifi/realtek/drivers/8188eu/rtl8xxx_EU/8188eu.ko $(TARGET_OUT)/lib/
