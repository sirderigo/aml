...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
PROJECT_NAME=k200_hdmiin
PROJECT_DT=meson8_k200a_1G_hdmiin
if [ "${BOARD_REVISION}" == "b" ]; then
    PROJECT_DT="meson8_k200b_1G_emmc_sdio_hdmiin meson8_k200b_1G_emmc_sdhc_hdmiin meson8_k200b_2G_emmc_sdhc_hdmiin meson8_k200b_2G_emmc_sdio_hdmiin meson8m2_n200_1G_hdmiin meson8m2_n200_2G_hdmiin"
elif [ "${BOARD_REVISION}" == "b_2G" ]; then
    PROJECT_DT="meson8_k200b_2G_emmc_sdhc_hdmiin meson8_k200b_2G_emmc_sdio_hdmiin"
elif [ "${BOARD_REVISION}" == "a_2G" ]; then
    PROJECT_DT=meson8_k200a_2G_hdmiin
fi
