...
KERNEL_DEVICETREE := meson8b_m201_th12_1G
#KERNEL_DEVICETREE := meson8b_m201_th12_1G_common
#KERNEL_DEVICETREE := meson8b_m201_th12_1G_costdown

ifeq ($(TARGET_USE_SECUREOS),true)
KERNEL_DEFCONFIG := meson8b_tee_defconfig
else
KERNEL_DEFCONFIG := meson8b_m201_th12_defconfig
endif
...
#cp $(KERNEL_OUT)/drivers/amlogic/bluetooth/rtk8723/rtk_btusb.ko $(TARGET_OUT)/lib/
#cp $(KERNET_ROOTDIR)/arch/arm/boot/dts/amlogic/$(KERNEL_DEVICETREE).dtd $(PRODUCT_OUT)/meson_target.dtd
