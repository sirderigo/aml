...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m201_th12
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m201_th12/res_pack_bax101
else
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m201_th12/res_pack
endif
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m201_th12/aml_logo.bmp
# Check Logo Size
