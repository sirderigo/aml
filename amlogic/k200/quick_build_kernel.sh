...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
PROJECT_NAME=k200
PROJECT_DT=meson8_k200a_1G
if [ "${BOARD_REVISION}" == "b" ]; then
    PROJECT_DT="meson8_k200b_1G_emmc_sdio meson8_k200b_1G_emmc_sdhc meson8_k200b_2G_emmc_sdhc meson8_k200b_2G_emmc_sdio meson8m2_n200_1G meson8m2_n200_2G"
elif [ "${BOARD_REVISION}" == "b_2G" ]; then
    PROJECT_DT="meson8_k200b_2G_emmc_sdhc meson8_k200b_2G_emmc_sdio"
elif [ "${BOARD_REVISION}" == "a_2G" ]; then
    PROJECT_DT=meson8_k200a_2G
fi
