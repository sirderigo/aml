...
KERNEL_DEVICETREE := meson8_k200a_1G

ifeq ($(BOARD_REVISION),a_2G)
    KERNEL_DEVICETREE := meson8_k200a_2G
endif
ifeq ($(BOARD_REVISION),b)
    KERNEL_DEVICETREE := meson8_k200b_1G_emmc_sdio meson8_k200b_1G_emmc_sdhc meson8_k200b_2G_emmc_sdhc meson8_k200b_2G_emmc_sdio meson8m2_n200_1G meson8m2_n200_2G
else
ifeq ($(BOARD_REVISION),b_2G)
    KERNEL_DEVICETREE := meson8_k200b_2G_emmc_sdhc meson8_k200b_2G_emmc_sdio
endif
endif
